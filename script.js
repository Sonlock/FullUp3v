  ...
  $( document ).ready(function() {
    ...
    $("input[type='radio']").change(function(){
      ...
      if(vehiculo1 == 2){
        ...
        $("#opciones2,#opciones3,#conos,#carga2,#carga3,#carga4,#carga5,#carga6,label[for='conos']").hide();
        $("#opciones3").show();

      } else if (vehiculo1 == 1){

      $("#opciones2,#conos,#carga2,#carga3,#carga4,#carga5,#carga6,label[for='conos']").show();
      $("#opciones3").hide();
    }
